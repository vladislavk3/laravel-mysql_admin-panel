              ...
              <div class="card-body">
                  ...
                  <div class="form-group col-sm-10">
                    ...
                    <div class="row">
                      <div class="form-group col-sm-6">
                        ...
                        <input type="text" name="first_name" class="form-control" id="first_name" value="{{$category->first_name}}" required>
                      </div>
                      <div class="form-group col-sm-6">
                        <label for="last_name">Last Name</label>
                        <input type="text" name="last_name" class="form-control" id="last_name" value="{{$category->last_name}}" required>
                      </div>
                    </div>
                  </div>
                  <div class="form-group col-sm-1">
                ...
                <div class="row">
                  ...
                  <div class="form-group col-sm-10">
                    ...
                    <div class="row">
                      <div class="form-group col-sm-6">
                        <input type="text" name="mobile_phone" class="form-control" id="mobile_phone" value="{{$category->mobile_phone}}" required>
                      </div>
                    </div>
                  </div>
                  <div class="form-group col-sm-1">
                ...
                <div class="row">
                  ...
                  <div class="form-group col-sm-10">
                    ...
                    <div class="row">
                      <div class="form-group col-sm-6">
                        <input type="text" name="email" class="form-control" id="email" value="{{$category->email}}" required>
                      </div>
                    </div>
                  </div>
                  <div class="form-group col-sm-1">
                ...
                <div class="row">
                  ...
                  <div class="form-group col-sm-10">
                    <div class="row">
                      ...
                      <div class="radio">
                        <label for="male">
                          <input type="radio" id="male" name="gender" value="0" <?php  echo $category->gender == 0?'checked':''?>> Male
                        </label>
                      </div>
                      <div class="radio">
                        <label for="female">
                          <input type="radio" id="female" name="gender" value="1" <?php  echo $category->gender == 1?'checked':''?>> Female
                        </label>
                      </div>
                  </div>
                  <div class="form-group col-sm-1">
                  ...
                  <div class="form-group col-sm-10">
                    ...
                    <div class="row">
                      <div class="form-group col-sm-3">
                        <input type="date" name="birthday" class="form-control" id="birthday" value="{{ $category->birthday }}" required>
                      </div>
                    </div>
                  </div>
                  <div class="form-group col-sm-1">
                ...
                <div class="row">
                  ...
                  <div class="form-group col-sm-10">
                    ...
                    <div class="row">
                      <div class="form-group col-sm-6">
                        <select id="married_status" name="married_status" class="form-control">
                ...
                <div class="row">
                  ...
                  <div class="form-group col-sm-10">
                    ...
                    <div class="row">
                      <div class="form-group col-sm-6">
                        <input type="text" name="skype_id" class="form-control" id="skype_id" value="{{ $category->skype_id }}">
                      </div>
                    </div>
                  </div>
                  <div class="form-group col-sm-1">
                ...
                <div class="row">
                  ...
                  <div class="form-group col-sm-10">
                    ...
                    <div class="row">
                      <div class="form-group col-sm-6">
                        <input type="text" name="instagram_id" class="form-control" id="instagram_id" value="{{ $category->instagram_id }}">
                      </div>
                    </div>
                  </div>
                  <div class="form-group col-sm-1">
                  ...
                  <div class="form-group col-sm-10">
                    ...
                    <div class="row">
                      <div class="form-group col-sm-12">
                        ...
                        <input type="text" name="street_address" class="form-control" id="street_address" value="{{ $category->street_address }}" required>
                      </div>
                      <div class="form-group col-sm-12">
                        <label for="address_line2">Address Line 2</label>
                        <input type="text" name="address_line2" class="form-control" id="address_line2" value="{{ $category->address_line2 }}" required>
                      </div>
                      <div class="form-group col-sm-6">
                      ...
                      <div class="form-group col-sm-6">
                        ...
                        <input type="text" name="state_province_region" class="form-control" id="state_province_region" value="{{ $category->state_province_region }}" required>
                      </div>
                      <div class="form-group col-sm-6">
                        <label for="zip_postal_code">ZIP / Postal Code</label>
                        <input type="text" name="zip_postal_code" class="form-control" id="zip_postal_code" value="{{ $category->zip_postal_code }}" required>
                      </div>
                      <div class="form-group col-sm-6">
                ...
                <div class="row">
                  ...
                  <div class="form-group col-sm-10">
                    ...
                    <div class="row">
                      <div class="form-group col-sm-3">
                        <input type="date" class="form-control" id="passport_expire_date" name="passport_expire_date" value="{{ $category->passport_expire_date }}" required>
                      </div>
                    </div>
                  </div>
                  <div class="form-group col-sm-1">
                ...
                <div class="row">
                  ...
                  <div class="form-group col-sm-10">
                    ...
                    <div class="row">
                      <div class="form-group col-sm-6">
                        <input type="text" name="university" class="form-control" id="university" value="{{ $category->university }}">
                      </div>
                    </div>
                  </div>
                  <div class="form-group col-sm-1">
                ...
                <div class="row">
                  ...
                  <div class="form-group col-sm-10">
                    ...
                    <div class="row">
                      <div class="form-group col-sm-6">
                        <input type="text" name="major" class="form-control" id="major" value="{{ $category->major }}" required>
                      </div>
                    </div>
                  </div>
                  <div class="form-group col-sm-1">
                ...
                <div class="row">
                  ...
                  <div class="form-group col-sm-10">
                    ...
                    <div class="row">
                      <div class="form-group col-sm-3">
                        <input type="date" name="from" class="form-control" id="from" value="{{ $category->from }}" required>
                      </div>
                    </div>
                  </div>
                  <div class="form-group col-sm-1">
                ...
                <div class="row">
                  ...
                  <div class="form-group col-sm-10">
                    ...
                    <div class="row">
                      <div class="form-group col-sm-3">
                        <input type="date" name="to" class="form-control" id="to" value="{{ $category->to }}" required>
                      </div>
                    </div>
                  </div>
                  <div class="form-group col-sm-1">
                ...
                <div class="row">
                  ...
                  <div class="form-group col-sm-10">
                    ...
                    <div class="row">
                      <div class="form-group col-sm-6">
                        <input type="number" name="gpa_score" class="form-control" id="gpa_score" value="{{ $category->gpa_score }}" required step="0.1" min="0">
                      </div>
                    </div>
                  </div>
                  <div class="form-group col-sm-1">
                ...
                <div class="row">
                  ...
                  <div class="form-group col-sm-10">
                    ...
                    <div class="radio">
                      <label for="ep-yes">
                        <input type="radio" id="ep-yes" name="english_proficiency" value="0" {{ $category->english_proficiency == 0?'checked':'' }} > Yes
                      </label>
                    </div>
                    <div class="radio">
                      <label for="ep-no">
                        <input type="radio" id="ep-no" name="english_proficiency" value="1" {{ $category->english_proficiency == 1?'checked':'' }} > No
                      </label>
                    </div>
                  </div>
                  <div class="form-group col-sm-1">
                ...
                <div class="row" id="english_proficiency_indicate" {{ $category->english_proficiency == 0? '': 'hidden' }}>
                  ...
                  <div class="row" id="english_proficiency_true" {{ ($category->indicate == 0 || $category->indicate == 1)? '' : 'hidden' }}>
                    ...
                    <div class="form-group col-sm-10">
                      ...
                      <div class="row">
                        <div class="form-group col-sm-6">
                          <input type="number" name="indicate_overall" class="form-control" id="overall" min="0" max="10" step="0.1" value="{{ $category->indicate_overall }}">
                    ...
                    <div class="form-group col-sm-10">
                      ...
                      <div class="row">
                        <div class="form-group col-sm-6">
                          <input type="number" name="indicate_writing" class="form-control" id="writing" min="0" max="10" step="0.1" value="{{ $category->indicate_writing }}">
                          <span>Please enter a value between 0 and 10.</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="form-group col-sm-10">
                      ...
                      <div class="row">
                        <div class="form-group col-sm-6">
                          <input type="number" name="indicate_listening" class="form-control" id="listening" min="0" max="10" step="0.1" value="{{ $category->indicate_listening }}">
                          <span>Please enter a value between 0 and 10.</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="form-group col-sm-10">
                      ...
                      <div class="row">
                        <div class="form-group col-sm-6">
                          <input type="number" name="indicate_reading" class="form-control" id="reading" min="0" max="10" step="0.1" value="{{ $category->indicate_reading }}">
                          <span>Please enter a value between 0 and 10.</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="form-group col-sm-10">
                      ...
                      <div class="row">
                        <div class="form-group col-sm-6">
                          <input type="number" name="indicate_speaking" class="form-control" id="speaking" min="0" max="10" step="0.1" value="{{ $category->indicate_speaking }}">
                          <span>Please enter a value between 0 and 10.</span>
                        </div>
                      </div>
                    </div>
                ...
                <div class="row">
                  ...
                  <div class="form-group col-sm-10">
                    ...
                    <div class="radio">
                      <label for="fp-yes">
                        <input type="radio" id="fp-yes" name="french_proficiency" value="0" {{ $category->french_proficiency == 0?'checked':'' }} > Yes
                      </label>
                    </div>
                    <div class="radio">
                      <label for="fp-no">
                        <input type="radio" id="fp-no" name="french_proficiency" value="1"  {{ $category->french_proficiency == 1?'checked':'' }} > No
                      </label>
                    </div>
                  </div>
                  <div class="form-group col-sm-1">
                ...
                <div class="row">
                  ...
                  <div class="form-group col-sm-10">
                    ...
                    <div class="row">
                      <div class="form-group col-sm-6">
                        <input type="text" name="latest_job_title" class="form-control" id="latest_job_title" value="{{ $category->latest_job_title }}" required>
                      </div>
                    </div>
                  </div>
                  <div class="form-group col-sm-1">
                ...
                <div class="row">
                  ...
                  <div class="form-group col-sm-10">
                    ...
                    <div class="radio">
                      <label for="ah-yes">
                        <input type="radio" id="ah-yes" name="applid" value="0" {{ $category->applid == 0?'checked':'' }}> Yes
                      </label>
                    </div>
                    <div class="radio">
                      <label for="ah-no">
                        <input type="radio" id="ah-no" name="applid" value="1" {{ $category->applid == 1?'checked':'' }}> No
                      </label>
                    </div>
                  </div>
                  <div class="form-group col-sm-1">
                      ...
                      <div class="form-group col-sm-12">
                        ...
                        <div class="checkbox">
                          <label for="educational_consultation">
                            <input type="checkbox" id="educational_consultation" name="educational_consultation" value="1" {{ ($service_list[0] == 1)? 'checked': '' }}> Educational consultation
                          </label>
                        </div>
                        <div class="checkbox">
                          <label for="apply_admission">
                            <input type="checkbox" id="apply_admission" name="apply_admission" value="1" {{ ($service_list[1] == 1)? 'checked': '' }}> Apply for Admission
                          </label>
                        </div>
                        <div class="checkbox">
                          <label for="credential">
                            <input type="checkbox" id="credential" name="credential" value="1" {{ ($service_list[2] == 1)? 'checked': '' }}> Credential assessment/Equivalent
                          </label>
                        </div>
                        <div class="checkbox">
                          <label for="apply_fund">
                            <input type="checkbox" id="apply_fund" name="apply_fund" value="1" {{ ($service_list[3] == 1)? 'checked': '' }}> Apply for fund/Scholarship
                          </label>
                        </div>
                        <div class="checkbox">
                          <label for="apply_accommodations">
                            <input type="checkbox" id="apply_accommodations" name="apply_accommodations" value="1" {{ ($service_list[4] == 1)? 'checked': '' }}> Apply for housing accommodations
                          </label>
                        </div>
                        <div class="checkbox">
                          <label for="apply_insurance">
                            <input type="checkbox" id="apply_insurance" name="apply_insurance" value="1" {{ ($service_list[5] == 1)? 'checked': '' }}> Apply for student health insurance
                          </label>
                        </div>
                        <div class="checkbox">
                          <label for="help_permits">
                            <input type="checkbox" id="help_permits" name="help_permits" value="1" {{ ($service_list[6] == 1)? 'checked': '' }}> Help to get study and work permits
                          </label>
                        </div>
                        <div class="checkbox">
                          <label for="travel_consultation">
                            <input type="checkbox" id="travel_consultation" name="travel_consultation" value="1" {{ ($service_list[7] == 1)? 'checked': '' }}> Travel arrangement consultation
                          </label>
                        </div>
                        <div class="checkbox">
                          <label for="airport_transfer">
                            <input type="checkbox" id="airport_transfer" name="airport_transfer" value="1" {{ ($service_list[8] == 1)? 'checked': '' }}> Airport transfer
                          </label>
                        </div>
                        <div class="checkbox">
                          <label for="help_registration">
                            <input type="checkbox" id="help_registration" name="help_registration" value="1" {{ ($service_list[9] == 1)? 'checked': '' }}> Help for registration
                          </label>
                        </div>
                        <div class="checkbox">
                          <label for="help_bank">
                            <input type="checkbox" id="help_bank" name="help_bank" value="1" {{ ($service_list[10] == 1)? 'checked': '' }}> Help to open bank accounts
                          </label>
                        </div>
                        <div class="checkbox">
                          <label for="help_driving">
                            <input type="checkbox" id="help_driving" name="help_driving" value="1" {{ ($service_list[11] == 1)? 'checked': '' }}> Help to get driving licence
                          </label>
                        </div>
                      </div>
                    </div>
                ...
                <div class="row">
                  ...
                  <div class="form-group col-sm-10">
                    ...
                    <div class="row">
                      <div class="form-group col-sm-6">
                        <input type="text" name="agent_name" class="form-control" id="agent_name" value="{{ $category->agent_name }}">
                      </div>
                    </div>
                  </div>
                  <div class="form-group col-sm-1">
                    ...
                    <div class="card">
                      <div class="card-body">
                        <div style="text-align: center;">
                          ...
                          <input type="file" id="resume_filename" onchange="resume_change()" name="resume_filename" multiple accept=".pdf, .jpg, .png" style="opacity: 0;">
                        </div>
                      </div>
                    </div>
...
<script type="text/javascript">
  ...
  function resume_change() {
    var file = $('#resume_filename').val();
